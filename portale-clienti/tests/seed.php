...
C::exec("INSERT INTO users(first_name,last_name,email,password_hash,role) VALUES(?,?,?,?,'admin')",['Ada','Admin','caniatoa@libero.it',password_hash('test-password-1234',PASSWORD_DEFAULT)]);
C::exec("INSERT INTO users(first_name,last_name,email,password_hash,role) VALUES(?,?,?,?,'operator')",['Olivia','Operatore','operator@example.invalid',password_hash('test-password-1234',PASSWORD_DEFAULT)]);
